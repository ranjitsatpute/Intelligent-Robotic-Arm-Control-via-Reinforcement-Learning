...
class CriticNetwork(nn.Module):
    def __init__(self, input_dims, n_actions, fc1_dims=256, fc2_dims=256, name="critic", checkpoint_dir='tmp/td3', learning_rate=10e-3):
        ...
        self.q = nn.Linear(self.fc2_dims, out_features= 1)
